...
function render_block_core_latest_posts( $attributes ) {
	...
	foreach ( $recent_posts as $post ) {
		...
		$list_items_markup .= sprintf(
			'<div class="con"><a href="%1$s"><img src=\'/img/news_pic11.png\' border=\'0\' width=\'100%%\' height=\'50%%\' alt=\'image\'><h2>%2$s<h2><h3>...</h3></a></div>',
		...
		if ( isset( $attributes['displayPostContent'] ) && $attributes['displayPostContent']
			...
			if ( strpos( $trimmed_excerpt, ' &hellip; ' ) !== false ) {
				$list_items_markup .= sprintf(
					'<div class="con"><a href="%1$s"><img src=\'/img/news_pic11.png\' border=\'0\' width=\'100%\' height=\'50%\' alt=\'image\'><h2>%2$s<h2><h3>...</h3></a></div></div>',
					esc_url( get_permalink( $post ) ),
					__( 'Read more' )
				);
			} else {
